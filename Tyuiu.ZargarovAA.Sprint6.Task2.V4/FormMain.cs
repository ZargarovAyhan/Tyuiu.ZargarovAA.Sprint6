...
using Tyuiu.ZargarovAA.Sprint6.Task2.V4.Lib;
...
namespace Tyuiu.ZargarovAA.Sprint6.Task2.V4
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 2 выполнил студент группы ИППБ-23-3 Заргаров Айхан Ахатович", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
